          ...
          <div class="hero-content text-center">
            <div class="max-w-2xl">
              ...
              <p class="text-lg sm:text-xl mt-4">
                InfoinYuk adalah platform untuk berbagi cerita dan informasi dengan mudah. Dibuat sebagai bagian dari proyek
                <strong>Dicoding Belajar Pengembangan Web Intermediate</strong> oleh Muhammad Syarifudin.
              </p>
              <p class="text-base sm:text-lg mt-4">
                Kami percaya bahwa setiap cerita memiliki makna. Dengan InfoinYuk, Anda dapat membagikan pengalaman Anda,
