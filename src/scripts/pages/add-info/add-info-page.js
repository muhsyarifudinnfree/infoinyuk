...
export default class Addinfo {
  ...
  async render() {
    return `
      <section class="container mx-auto px-4 py-12 animate-fade-in min-h-[80vh]" role="main" aria-label="Formulir tambah cerita">
        <div class="text-center mb-8">
          <h1 class="text-2xl sm:text-3xl font-bold">Cerita Apa Hari Ini?</h1>
          <p class="text-base sm:text-lg mt-2">Lengkapi form di bawah untuk membagikan cerita</p>
        </div>
            ...
            <form id="add-info-form" class="flex flex-col gap-6" role="form" aria-labelledby="add-info-title">
              <div class="form-control">
                ...
                <textarea 
                  id="description" 
                  name="description" 
                  placeholder="Ceritakan kisahmu di sini..." 
                  required 
              ...
              <div class="form-control">
                ...
                <div id="map-loading-container" class="hidden flex items-center justify-center h-80 bg-base-200 rounded-lg">
    ...
    actionOpenCamera?.addEventListener("click", async (event) => {
      ...
      if (this.#isCameraOpen) {
        ...
        event.currentTarget.innerHTML = `
          ...
          Buka Kamera
        `;
        event.currentTarget.setAttribute("aria-label", "Buka kamera untuk mengambil gambar");
        this.#camera?.stop();
  ...
  clearForm() {
    ...
    if (actionOpenCamera) {
      actionOpenCamera.innerHTML = `
        ...
        Buka Kamera
      `;
      actionOpenCamera.setAttribute("aria-label", "Buka kamera untuk mengambil gambar");
    }
    ...
    if (submitButtonContainer) {
      submitButtonContainer.innerHTML = `
        <button 
          ...
          disabled 
          aria-disabled="true"
          aria-label="Sedang mengirim cerita"
        >
          <span class="loading loading-spinner" aria-hidden="true"></span> Kirim Cerita
        </button>
      `;
    }
  }
